...
namespace Fasta
{
    public record FastaSequence(string Value)
    {
    ...
    public record FastaId(string Value)
    {
        public override string ToString() => Value;
    }

    public record FastaRecord(FastaId Id, FastaSequence Sequence)
    {
    ...
    public record FastaFile(Dictionary<FastaId, FastaSequence> Records)
    {
